...
- 1.4.2 (current): only in B42: made the decal button visible during character creation (required some small re-arragnement of texture and colot buttons to make it work); a few changes to profession clothing; changed body 
...
English, German. Additional translations are welcome, in case you would like to make one. Feel free to ask in the comment section of the mod's workshop page.
