...
local function doRasTraits()
    ...
    CharacterTraitDefinition.setMutualExclusive(CharacterTrait.get(ResourceLocation.of("rasprofs:rasfastreaderprof")), CharacterTrait.get(ResourceLocation.of("base:slowreader")))
