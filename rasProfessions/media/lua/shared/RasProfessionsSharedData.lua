-- contains several tables used by this mod; data are all related to hair styles
--
--
-- by razab
...
-- contains hair styles which a profession shouldn't get randomly assigned during character creation
local excludedHairStyles = { 
    ...
    Male = { 
        ...
        rasTailor = { LibertySpikes = true,  MohawkSpike = true, MohawkFan = true, MohawkFlat = true, MohawkShort = true},
        rasITProf = { },
...
-- write all allowed hair styles for a profession to table
